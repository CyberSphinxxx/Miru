...
interface MovieQuickAddDropdownProps {
    movie: Movie;
    className?: string;
}

const MovieQuickAddDropdown: React.FC<MovieQuickAddDropdownProps> = ({ movie, className = '' }) => {
    ...
    const handleStatusChange = (e: React.MouseEvent, status: MovieLibraryStatus) => {
        e.stopPropagation();
    ...
    const statuses: { key: MovieLibraryStatus; label: string; color: string }[] = [
    ...
    return (
        <div className={`relative ${className}`} ref={dropdownRef}>
            <button
                ...
                title={currentStatus ? getStatusLabel(currentStatus) : 'Add to list'}
            >
                {currentStatus ? (
...
export default React.memo(MovieQuickAddDropdown);
