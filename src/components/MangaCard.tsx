 ...
 */
const MangaCard: React.FC<MangaCardProps> = ({ manga, onClick, onReadClick, onDelete }) => {
        ...
        >
            ...
            >
                ...
                <div className="relative aspect-[2/3] overflow-hidden">
                    ...
                    {/* Delete Button - Only when onDelete provided */}
                    {onDelete && !showDetails && (
                        <button
                            ...
                            className="absolute top-2 right-2 p-1.5 rounded-md bg-red-500/80 hover:bg-red-500 text-white opacity-0 group-hover:opacity-100 transition-all z-10"
