                                    ...
                                    <div className="max-w-2xl animate-fade-in-up">
                                        ...
                                        <div className="flex items-center gap-4">
                                            <button
                                                ...
                                                className="flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-miru-primary to-miru-accent text-white font-bold shadow-lg shadow-miru-primary/50 hover:shadow-miru-primary/70 transition-all hover:scale-105"
                                            >
