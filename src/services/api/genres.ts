...
const GENRES: Genre[] = [
    ...
    { id: 9, name: 'Ecchi', count: 0 },
    { id: 10, name: 'Fantasy', count: 0 },
    { id: 14, name: 'Horror', count: 0 },
    { id: 66, name: 'Mahou Shoujo', count: 0 },
    { id: 18, name: 'Mecha', count: 0 },
    { id: 19, name: 'Music', count: 0 },
    { id: 7, name: 'Mystery', count: 0 },
    { id: 40, name: 'Psychological', count: 0 },
    ...
    { id: 62, name: 'Isekai', count: 0 },
    { id: 63, name: 'Iyashikei', count: 0 }
];
